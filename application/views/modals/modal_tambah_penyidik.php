<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
    ...
    <h3 style="display:block; text-align:center;">Tambah Data Penyidik</h3>

    <form id="form-tambah-penyidik" method="POST">
        ...
        <div class="input-group form-group">
            ...
            <input type="text" class="form-control" placeholder="Nomor Telepon" name="number_handphone" aria-describedby="sizing-addon2">
        </div>
